...
import { HomeIcon, WalletIcon, ChartBarIcon, CameraIcon } from "@heroicons/react/24/outline";
...
const BottomNav: React.FC = () => {
  ...
  const navItems = [
    ...
    {path: walletId ? `/scan/${walletId}`:"/",icon: <CameraIcon className="w-8 h-8" />,label: "Scan"},
